...
def llm_call(function_body, module_path):
    ...
    api_key = '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'
    ...
    try:
        ...
        completion = client.chat.completions.create(
                model="gpt-3.5-turbo",
                messages=[
                    {"role": "system", "content": "You are an IT software Engineer. You are developing an python application. Given the following code writethe unit test cases:"},
